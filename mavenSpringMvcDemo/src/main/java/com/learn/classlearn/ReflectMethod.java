...
public class ReflectMethod {
	...
	public static void main(String[] args) throws ClassNotFoundException,
		...
		/**
		 * 输出结果: draw 圈圈,count=15 drawCircle count:100
		 *
		 * 
		 * 
		 * 
		 ...
		 * }
		 * 
		 * /** 输出结果: method:public void reflect.Shape.draw(int,java.lang.String)
		 * 
